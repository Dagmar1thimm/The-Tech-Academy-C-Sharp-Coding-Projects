...
namespace TravelAgency.Controllers
{
    public class AgenciesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AgencyID,Name,Location")] Agency agency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AgencyID,Name,Location")] Agency agency)
        {
            if (ModelState.IsValid)
            {
